...
class FatPercentageCalculator extends StateNotifier<double?> {
  ...
  Future<double?> calculateFatPercentage({
    ...
    if (gender.toLowerCase() == 'male') {
      ...
      result = 163.205 * log10(waist + hip! - neck) - 97.684 * log10(height) - 78.387;
    }
...
final fatPercentageCalculatorProvider = StateNotifierProvider<FatPercentageCalculator, double?>((ref) {
